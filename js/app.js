		...
		$.fn.cardSlider = function (options) {
			...
			this.followContent = function () {
				if (this.params.followingClass) {
					//$('.'+this.params.followingClass).hide().removeClass("active-slide");
					$('.' + this.params.followingClass).removeClass('active-slide-new');
					$('.' + this.params.followingClass).removeClass('active-slide');
					var slide = this.getSlideByIndex(this.getIndex(this.current));
					if (slide) {
						var index = slide.data('index');
						// $('.'+this.params.followingClass).removeAttr( "class" );

						//$('.'+this.params.followingClass+'[data-index="'+index+'"]').prev().addClass("left2").removeClass("left1 right1 right2");
						//$('.'+this.params.followingClass+'[data-index="'+index+'"]').prev().prev().addClass("left1").removeClass("left2 right1 right2");
						//$('.'+this.params.followingClass+'[data-index="'+index+'"]').show().removeClass("left2 left1 right1 right2");
						//$('.'+this.params.followingClass+'[data-index="'+index+'"]').show().addClass("active-slide");
						$('.' + this.params.followingClass + '[data-index="' + index + '"]').addClass('active-slide');

						//$('.'+this.params.followingClass+'[data-index="'+index+'"]').next().addClass("right1").removeClass("left2 left1 right2");
						//$('.'+this.params.followingClass+'[data-index="'+index+'"]').next().next().addClass("right2").removeClass("left2 left1 right1");
